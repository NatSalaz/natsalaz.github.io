(
  ...
  function () {
    ...
    document.addEventListener('DOMContentLoaded', function () {
      ...
      // Bandeau de développement temporaire
      const devBanner = document.getElementById('dev-banner');
      if (devBanner) {
        // Affiche après un court délai pour permettre le rendu initial
        setTimeout(() => devBanner.classList.add('show'), 150);
        // Retire après 3 secondes (la transition de sortie dure 0.3s)
        setTimeout(() => devBanner.classList.remove('show'), 5150);
      }
    });
  })();
